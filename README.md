# 🛡️ Olá! Eu sou o Victor Ramalho (Kaxcav)

**Cloud Security Engineer | Especialista em SOC N2 | DevSecOps**

Atuo na linha de frente da defesa cibernética de infraestruturas críticas governamentais (Ministérios). Minha especialidade é arquitetar ambientes Zero Trust, caçar ameaças (Threat Hunting) e automatizar respostas a incidentes utilizando automação (Python/PowerShell) e inteligência de dados.

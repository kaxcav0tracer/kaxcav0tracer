...
<div align="center">
  <table border="0" cellpadding="15" cellspacing="0" bgcolor="#0D1117" width="700" style="border-radius: 10px; border: 1px solid #30363d;">
    <tr>
      <td align="left">
        <code>🔴 🟡 🟢</code><br><br>
        <pre align="left" style="background-color: transparent; border: none;">
<code><b>❯ whoami</b></code>
<code><b>User......:</b> <span style="color: #BB9AF0;">victor.mercury</span></code>
<code><b>Role......:</b> <span style="color: #2AC3DE;">Cybersecurity Analyst | DevSecOps</span></code>
<code><b>Org.......:</b> <span style="color: #7AA2F7;">ZeroDay Research Lab</span></code>
<code><b>Academic..:</b> <span style="color: #9ECE6A;">Software Engineering</span></code>
<code><b>Focus.....:</b> <span style="color: #E0AF68;">Threat Hunting | Detection as Code | Automation</span></code>
<code><b>Status....:</b> <img src="https://img.shields.io/badge/SYSTEM-ONLINE-00FF00?style=flat-square" height="15"> <img src="https://img.shields.io/badge/FIREWALL-ACTIVE-0078D4?style=flat-square" height="15"></code>
<code><b>Location..:</b> <span style="color: #F7768E;">Undisclosed Location</span></code></pre>
      </td>
    </tr>
  </table>
</div>
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/SC--401-Info_Protection-0078D4?style=for-the-badge&logo=microsoft&logoColor=white" />
</div>
...
<div align="center">
  ...
  <img src="https://skillicons.dev/icons?i=python,powershell,bash,java,php,c,cpp,fastapi,nodejs,linux,ubuntu,debian,kali,windows,aws,azure,gcp,docker,kubernetes,jenkins,terraform,ansible,elasticsearch,postgres,mysql,sqlite,redis,rabbitmq,nginx,cloudflare,prometheus,sentry,git,github,gitlab,githubactions,bitbucket,postman,vim,vscode,regex,markdown&perline=14" />
  <br><br>
  ...
  <table border="0" style="background-color: transparent;">
    <tr>
      <td width="50%" align="center" valign="top">
        <h3><a href="https://github.com/kaxcav0trace/artemis-project" style="text-decoration: none; color: #2AC3DE;">🏹 Artemis SOAR Project</a></h3>
        ...
        <br><br>
        <blockquote align="left" style="border-left: 3px solid #2AC3DE; padding-left: 10px;">
          <i>Orquestrador SOAR de alta performance com cache em PostgreSQL e automação de bloqueio em Firewalls FortiGate.</i>
        </blockquote>
      </td>
      <td width="50%" align="center" valign="top">
        <h3><a href="https://github.com/kaxcav0trace/secops-automation-suite-v2" style="text-decoration: none; color: #2AC3DE;">⚡ Sentinel Automation</a></h3>
        ...
        <br><br>
        <blockquote align="left" style="border-left: 3px solid #2AC3DE; padding-left: 10px;">
          <i>Laboratório híbrido e automação de Threat Hunting, reduzindo MTTR com integração direta a APIs.</i>
        </blockquote>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center" valign="top">
        <br>
        <h3><a href="https://github.com/kaxcav0trace/k8s-wazuh-lab" style="text-decoration: none; color: #2AC3DE;">👁️ SecOps Observability</a></h3>
      ...
      <td width="50%" align="center" valign="top">
        <br>
        <h3><a href="#" style="text-decoration: none; color: #2AC3DE;">🛡️ Secure Gateway</a></h3>
...
<div align="center">
  ...
  <br>
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=kaxcav0trace&theme=tokyonight&hide_border=true&background=0D1117&random=1" height="175" alt="GitHub Streak" />
</div>
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=kaxcav0trace&label=SYS.VIEWS&color=0D1117&style=for-the-badge" alt="Visitor Count" />
</div>
